...
<SectionWrapper>
    ...
    >
        ...
        >
            Let's thinkimg & more doing. we are the trainer in your pocket full
            of <span class="italic">
                peronalized workouts , exercise explanations, analytics</span
            > and much more.
        </p>
        <CTAs />
        ...
        <div class="flex items-center justify-center gap-2 text-base">
            ...
            {#each [0, 1, 2, 3, 4] as index}
                <div class="grid place-items-center relative">
                    ...
                    <div
                        class="absolute top-0 left-0 grid place-items-center + {index ===
                        4
